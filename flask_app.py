...
# HTML template with Option 3 added
TEMPLATE = '''
<!DOCTYPE html>
<html>
<head>
...
<body onload="toggleSprintSets()">
    ...
    <form method="POST">
        ...
        <input type="radio" name="route" value="1" {{ 'checked' if selected_route == 1 else '' }} onchange="toggleSprintSets()"> 7.2 km (SCTC -> Sha Tin Sports Ground -> Lek Yuen Bridge -> SCTC, includes drills and sprints)<br>
        <input type="radio" name="route" value="2" {{ 'checked' if selected_route == 2 else '' }} onchange="toggleSprintSets()"> 10.3 km (SCTC -> Ma On Shan Promenade -> SCTC)<br>
        <input type="radio" name="route" value="3" {{ 'checked' if selected_route == 3 else '' }} onchange="toggleSprintSets()"> 10.9 km (SCTC -> Ma Bridge -> HK Science Park -> SCTC)<br><br>
